...
namespace DoAnTest.Areas.Admin.Controllers
{
    ...
    public class CartsController : Controller
    {
        ...
        public CartsController(DoAnTestContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,AccountId,ProductId,Quantity")] Carts carts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,AccountId,ProductId,Quantity")] Carts carts)
        {
            if (id != carts.id)
            {
                return NotFound();
